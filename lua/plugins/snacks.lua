    ...
    win = {
      input = {
        keys = {
          ...
          -- l opens the selected entry from the prompt too, as in oil (j/k are defaults)
          ["l"] = { "confirm", mode = "n", desc = "Open" },
      ...
      list = {
        keys = {
          ["J"] = "list_scroll_down",
          ["K"] = "list_scroll_up",
          ["<S-Down>"] = "list_scroll_down",
          ["<S-Up>"] = "list_scroll_up",
          ["l"] = "confirm", -- l opens the entry, as in oil
        },
      },
    },
  },
